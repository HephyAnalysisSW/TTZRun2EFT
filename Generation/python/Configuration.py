...
# TTZRun2EFT
from TTZRun2EFT.Tools.user import results_directory
...
def makeUniquePath():
    ...
    from TTZRun2EFT.Tools.user import tmp_directory
    import uuid
...
class Configuration:
    def __init__( self, model_name, MG260=False ):
        ...
        # Load model
        model_file = os.path.expandvars( "$CMSSW_BASE/python/TTZRun2EFT/Generation/parameters.py" )
        ...
        # MG file locations
        self.data_path = os.path.expandvars( '$CMSSW_BASE/src/TTZRun2EFT/Generation/data' )
    ...
    def __pre_initialize( self ):
        ...
        if not os.path.isdir( self.MG5_tmpdir+"/Models/"+self.model_name ):
            ...
            src_dir    =  os.path.expandvars( '$CMSSW_BASE/src/TTZRun2EFT/Generation/data/models/%s/UFO'%self.model_name )
