...
from TTZRun2EFT.Analysis.regions        import genTTGammaRegions  as genRegions
from TTZRun2EFT.Analysis.regions        import recoTTGammaRegions as regions

from TTZRun2EFT.Tools.TriggerSelector   import TriggerSelector
...
# Samples
if args.year == 2016:
    from TTZRun2EFT.Samples.nanoTuples_Summer16_private_semilep_postProcessed      import *
    if not args.noData:
        from TTZRun2EFT.Samples.nanoTuples_Run2016_14Dec2018_semilep_postProcessed import *

elif args.year == 2017:
    from TTZRun2EFT.Samples.nanoTuples_Fall17_private_semilep_postProcessed        import *
    if not args.noData:
        from TTZRun2EFT.Samples.nanoTuples_Run2017_14Dec2018_semilep_postProcessed import *

elif args.year == 2018:
    from TTZRun2EFT.Samples.nanoTuples_Autumn18_private_semilep_postProcessed      import *
    if not args.noData:
        from TTZRun2EFT.Samples.nanoTuples_Run2018_14Dec2018_semilep_postProcessed import *
...
#    from TTZRun2EFT.Analysis.regions import genTTGammaRegionsSmall  as genRegions
#    from TTZRun2EFT.Analysis.regions import recoTTGammaRegionsSmall as regions
