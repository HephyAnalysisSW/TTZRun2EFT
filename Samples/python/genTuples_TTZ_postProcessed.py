...
dirs['TTZ_EFT_3noref'] = [ "fwlite_ttZ_ll_LO_order3_8weights" ]
...
ttZ_ll_LO_order3_8weights               = Sample.fromDirectory( name="ttZ_ll_LO_order3_8weights", treeName="Events", isData=False, color=color.TTZ, texName="ttZ", directory=directories['TTZ_EFT_3noref'] )
